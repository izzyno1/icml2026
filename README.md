...
见[P2检查点](docs/P2_CHECKPOINT.md)、[首篇贡献卡](published/papers/OR_J4wRLmh29t/full_text_001.json)
...
| 真实研究 | 1 篇模型初筛闭环；3 篇主轨论文、6 篇前作，共 12 个 PDF；10 条便利候选，总体未知 |
...
当前授权到 P2。首篇模型初筛闭环已验收，第二篇正在真实 Pro 审读；逐篇扩展至最多十篇。版本与前作缺口继续保留，恢复时先读当前检查点。P3/P4 不自动启动。
